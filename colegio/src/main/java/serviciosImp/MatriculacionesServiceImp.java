...
import daoImp.Hib.MatriculacionesDAOImplHib;
...
public class MatriculacionesServiceImp implements IMatriculacionesService {
	...
	public double calcularTasa(String idAlumno, String idAsignatura) {
		IAsignaturasDAO asignaturasDAO = new AsignaturasDAOImplHib();
	...
	public int insertarMatriculacion(String idAsignatura, String idAlumno, String fecha, String tasa) {
		IMatriculacionesDAO matriculaciones = new MatriculacionesDAOImplHib();
		try {
	...
	public ArrayList<MatriculacionDTO> obtenerMatriculacionesPorFiltrosSinFecha(
	    ...
	    IMatriculacionesDAO matriculaciones = new MatriculacionesDAOImplHib();
	    return matriculaciones.obtenerMatriculacionesPorFiltrosSinFecha(
	            nombreAsignatura, nombreAlumno, activo);
	}

	@Override
	public int actualizarMatriculacion(String id, String idAsignatura, String idAlumno,
	        String fecha, String tasa) {

	    IMatriculacionesDAO matriculaciones = new MatriculacionesDAOImplHib();
	    try {
	        return matriculaciones.actualizarMatriculacion(
	                id, idAsignatura, idAlumno, fecha, tasa);
	    } catch (SQLException e) {
	        e.printStackTrace();
	    }
	    return 0;
